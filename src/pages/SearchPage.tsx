      ...
      <div className="forge-panel surface-card-strong p-4 sm:p-5">
        ...
        <div className="mt-4 relative">
          <input
            ...
            disabled={!SEARCH_URL}
            className="w-full rounded-xl border border-zinc-600/50 bg-surface-control px-4 py-3 pr-16 text-sm text-text-primary placeholder-zinc-500 outline-none disabled:opacity-40"
          />
          {loading ? (
