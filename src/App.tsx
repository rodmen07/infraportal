          ...
          <main id="main-content" tabIndex={-1} className="mt-6 space-y-6 focus:outline-none">
            ...
            <section className="forge-panel rounded-3xl border border-zinc-500/30 bg-zinc-900/80 p-6 shadow-2xl shadow-black/50 backdrop-blur-xl">
              <div className="flex flex-wrap items-start justify-between gap-5">
                <div className="max-w-2xl">
                  <p className="text-scale-xs font-semibold uppercase tracking-[0.24em] text-amber-300/90">Productionized offers</p>
              ...
              {pricing.note && <p className="mt-4 text-sm text-text-muted">{pricing.note}</p>}
            ...
            <section className="forge-panel rounded-3xl border border-zinc-500/30 bg-zinc-900/80 p-6 shadow-2xl shadow-black/50 backdrop-blur-xl sm:p-8">
              <div className="grid gap-8 md:grid-cols-2">
                <div>
                  <p className="text-scale-xs font-semibold uppercase tracking-[0.24em] text-emerald-300/90">Free Resource</p>
                ...
                <div className="space-y-3">
                  <div className="rounded-lg border border-zinc-700/40 bg-zinc-800/40 p-3">
                    <p className="text-xs font-semibold text-text-secondary">✓ 4 categories</p>
                    <p className="mt-1 text-xs text-text-muted">Security, Reliability, Operations, Cost</p>
                  </div>
                  <div className="rounded-lg border border-zinc-700/40 bg-zinc-800/40 p-3">
                    <p className="text-xs font-semibold text-text-secondary">✓ 20 assessment items</p>
                    <p className="mt-1 text-xs text-text-muted">Self-evaluate in 5-10 minutes</p>
                  </div>
                  <div className="rounded-lg border border-zinc-700/40 bg-zinc-800/40 p-3">
                    <p className="text-xs font-semibold text-text-secondary">✓ Actionable next steps</p>
                    <p className="mt-1 text-xs text-text-muted">30-minute free consultation offer</p>
                  </div>
                </div>
              </div>
            </section>
