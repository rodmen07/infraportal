        ...
        <span className="mt-1 flex flex-wrap items-center gap-1">
          ...
          {idHints.slice(0, 4).map((id) => (
            <button
              ...
              type="button"
              onClick={() => onChange(id)}
              className="rounded border border-zinc-700/50 bg-surface-control px-1.5 py-0.5 font-mono text-scale-xs text-amber-300/90 hover:border-amber-400/40 hover:text-accent-text"
            >
              {id}
            </button>
          ))}
